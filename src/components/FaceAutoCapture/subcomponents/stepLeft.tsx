  ...
  return (
    <div className={localStyles.stepLeft}>
      ...
      <GreenDegrade
        width={485}
        height={225}
        className={localStyles.green_degrade}
      />
      <div
        className={`${styles.stepLeftBackSquare} ${localStyles.stepLeftBackSquare}`}
      >
        <div
          className={`${localStyles.videoCaptureArea} notShowing`}
          ref={videoareaRef}
        >
          {!photoUrl && error === null && (
            <>
              ...
              <FaceUi
                instructions={{
                  brightness_too_high:
                    texts.other.cameraLabels.brightness_too_high,
                  brightness_too_low:
                    texts.other.cameraLabels.brightness_too_low,
                  candidate_selection:
                    texts.other.cameraLabels.candidate_selection,
                ...
                theme={{
                  colors: {
                    ...
                    instructionTextColor: 'transparent',
                    instructionColor: 'transparent',
                    instructionColorSuccess: 'transparent',
          ...
          <div
            className={localStyles.finalImgContainer}
